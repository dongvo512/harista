...
-(void)loadMoreSalon{
    ...
    [[SalonManage sharedInstance] getListFavoriteSalon:[NSString stringWithFormat:@"%ld",(long)indexPage] limit:LIMIT_ITEM dataResult:^(NSError *error, id idObject, NSString *strError) {
